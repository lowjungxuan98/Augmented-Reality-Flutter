...
class ObjectGesturesScreen extends StatefulWidget {
  const ObjectGesturesScreen({super.key});

  @override
  State<ObjectGesturesScreen> createState() => _ObjectGesturesScreenState();
}

class _ObjectGesturesScreenState extends State<ObjectGesturesScreen> {
